...
function WorkProcess() {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Identify and analyze target audience demographics and behaviors.",
    },
    {
      icon: "mdi:trending-up",
      title: "CONTENT CREATION",
      description:
        "Create engaging content optimized for different digital platforms.",
    },
    {
    ...
    },
    {
      ...
      title: "ANALYTICS",
      description:
        "Track performance metrics and optimize marketing strategies.",
    },
  ];
          ...
          >
            <div className="flex flex-col items-center text-center">
              <div className="relative mb-6 transition-transform duration-300 group-hover:scale-110">
                <div
                  className={`w-20 h-20 rounded-full border-2 border-dotted border-orange-500 flex items-center justify-center ${step.color}`}
                >
                  <Icon icon={step.icon} className="w-8 h-8 text-orange-500" />
                </div>
